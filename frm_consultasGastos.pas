...
uses
  ...
  dxSkinXmas2008Blue, dxSkinscxPCPainter, global,
  cxDataControllerConditionalFormattingRulesManagerDialog;

type
  TfrmConsultasgastos = class(TForm)
...
var
  frmConsultasgastos: TfrmConsultasgastos;
...
procedure TfrmConsultasgastos.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action := caFree ;
end;
